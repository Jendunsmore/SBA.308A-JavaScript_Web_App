...
Giphy API Key:  fBAFRB0gejbg8XdW2IIRLUO9fyv95pI2
...
<body>
    ...
    <main>
        ...
        <div class="grid-container">
            <div class="grid-item2">
                <p>What is your favorite Halloween movie?</p>
                <input [type=text]>
                <p>What is your favorite way to decorate?</p>
                <input [type=text]>
                <p>Share your costume ideas below:</p>
                <input [type=text]>
            </div>
            ...
            <div class="image-container">
                <img class="details-img" src="/Users/jenniferdunsmore/Desktop/Per Scholas/giphy.webp"> alt="NBC"
    ...
    <footer>Made with angst by a struggling bootcamp student
        ...
        <select name="Explore">
            <option value="currentProjects">Boo!</option>
...
https://t3.ftcdn.net/jpg/02/88/45/68/360_F_288456855_21v7h9hIWAHC99eJMqMrwSsmAiCe8zB1.jpg">


<img src="/Users/jenniferdunsmore/Desktop/Per Scholas/giphy.webp">
...
//--------------------- REQUIREMENTS: ------------------------------------------------
// 1. Use the fetch API or Axios to communicate with an external web API. Use the data provided
// by this API to populate your application’s content and features.
// 2. Create user interaction with the API through a search feature, paginated gallery, or
...
// 4. Organize your JavaScript code into at least three (3) different module files, and import
// functions and data across files as necessary.
// 5. Ensure the program runs as expected, without any undesired behavior caused by misunderstanding
// of the JavaScript event loop (such as race conditions, API calls being handled out of order, etc.).
// 6. Create an engaging user experience through the use of HTML and CSS.
// 7. Ensure that the program runs without errors (comment out things that do not work, and explain
// your blockers - you can still receive partial credit).
